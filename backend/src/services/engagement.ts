...
export const engagementService = {
   ...
   */
  async createRating(userId: string, input: RatingCreateInput) {
    try {
   ...
   */
  async getUserRating(userId: string, entityId: string, entityType: string) {
    try {
   ...
   * Delete rating
   */
  async deleteRating(userId: string, entityId: string, entityType: string) {
    try {
      const rating = await prisma.rating.findUnique({
        where: {
          userId_entityId_entityType: {
   ...
   */
  async getEntityRatings(entityId: string, entityType: string) {
    try {
   ...
   * Add to favorites
   */
  async addToFavorites(userId: string, input: FavoriteAddInput) {
    try {
   ...
   */
  async removeFromFavorites(userId: string, entityId: string, entityType: string) {
    try {
   ...
   */
  async getUserFavorites(userId: string, entityType?: string, page: number = 1, limit: number = 20) {
    try {
   ...
   * Add to watchlist
   */
  async addToWatchlist(userId: string, input: WatchlistAddInput) {
    try {
   ...
   */
  async getUserWatchlist(userId: string, page: number = 1, limit: number = 20) {
    try {
      const skip = (page - 1) * limit;
   ...
   */
  async updateHistory(userId: string, input: HistoryCreateInput) {
    try {
   ...
   */
  async getUserHistory(userId: string, entityType?: string, page: number = 1, limit: number = 20) {
    try {
      const skip = (page - 1) * limit;
   ...
   */
  async getWatchProgress(userId: string, entityId: string, entityType: string) {
    try {
