...
export const authService = {
   ...
   */
  verifyAccessToken(token: string): { id: string; type: string } | null {
    try {
   ...
   */
  verifyRefreshToken(token: string): { id: string; type: string } | null {
    try {
   ...
   */
  async changeUserPassword(userId: string, input: PasswordChangeInput) {
    try {
